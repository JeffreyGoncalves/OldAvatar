...
namespace Microsoft.Kinect.Toolkit.FaceTracking
{
    ...
    public class FaceTracker : IDisposable
    {
        ...
        [NonSerialized] private readonly Stopwatch copyStopwatch = new Stopwatch();
        ...
        /// Returns computed face tracking results for this image frame
        /// </returns>
        public FaceTrackFrame Track(ColorImageFormat colorImageFormat, byte[] colorImage, DepthImageFormat depthImageFormat, short[] depthImage)
        {
